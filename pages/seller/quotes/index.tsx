    ...
    >
      ...
      <Box sx={{ minWidth: 0 }}>
        ...
        {note && (
          <Typography
            variant='caption'
            sx={{ color: accentColor, fontWeight: 700, fontSize: '0.68rem' }}
          >
            {note}
          </Typography>
        )}
      ...
      <SellerAccountLayout>
        <WaitForCustomer waitFor={customerQuery}>
          ...
          <Box sx={{ mb: 3 }}>
            <Typography
              variant='h5'
              sx={{ fontWeight: 700, color: 'text.primary', letterSpacing: '-0.3px' }}
            >
          ...
          {loading && (
            <LinearProgress
              sx={{ borderRadius: 1, mb: 2, height: 3 }}
            />
          )}
            ...
            <Table>
              ...
              <TableBody>
                ...
                {filtered.map((quote, quoteIdx) => {
                  ...
                  const isLast = quoteIdx === filtered.length - 1
                  ...
                  return (
                    <React.Fragment key={quote.order_id}>
                      ...
                      {quoteIdx > 0 && (
                        <TableRow sx={{ '& td': { p: 0, border: 0 }, pointerEvents: 'none' }}>
                          <TableCell colSpan={7}>
                            <Box
                              sx={{
                                display: 'flex',
                      ...
                      >
                        ...
                        <TableCell sx={{ pt: 2.5, pb: 1, pl: isPending ? 1.5 : 2 }}>
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.25 }}>
                            ...
                            <Typography variant='body2' sx={{ fontWeight: 700, fontFamily: 'monospace', fontSize: '0.85rem', color: 'text.primary' }}>
                              #{quote.order_number}
                            </Typography>
                          </Box>
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.4, pl: isPending ? 1.75 : 0 }}>
                            <AccessTimeIcon sx={{ fontSize: 11, color: 'text.primary' }} />
                            <Typography variant='caption' color='text.primary' sx={{ fontSize: '0.68rem' }}>
                        ...
                        <TableCell sx={{ pt: 2.5, pb: 1 }}>
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.25 }}>
                            <Avatar sx={{ width: 30, height: 30, fontSize: '0.68rem', fontWeight: 700, bgcolor: '#e2e8f0', color: '#334155', flexShrink: 0 }}>
                        ...
                        <TableCell sx={{ pt: 2.5, pb: 1 }}>
                          <Box sx={{
                            ...
                            <Typography variant='caption' sx={{ fontWeight: 700, color: statusCfg.color, fontSize: '0.7rem' }}>
                              {statusCfg.label}
                            </Typography>
                          </Box>
                        </TableCell>
                        ...
                        <TableCell sx={{ pt: 2.5, pb: 1, textAlign: 'right' }}>
                          <Tooltip title='View & Respond'>
                            <IconButton size='small' sx={{ bgcolor: '#f1f5f9', borderRadius: 1.5, '&:hover': { bgcolor: '#e2e8f0' } }}>
                      ...
                      {/* ── Row 2+ : One product per sub-row, full-width ── */}
                      {quote.items.length === 0 ? (
                        <TableRow
                          onClick={() => router.push(`/account/seller/quotes/${quote.order_id}`)}
                          sx={{
                            cursor: 'pointer',
                            bgcolor: '#fff',
                            '&:hover td': { bgcolor: '#f8fafc' },
                        ...
                        >
                          <TableCell colSpan={7} sx={{ pt: 0.5, pb: 2.5, pl: isPending ? 1.5 : 2, pr: 2 }}>
                        ...
                        quote.items.map((item: any, itemIdx: number) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                {/* Product card — full width, clean uniform style */}
                                <Box
                                  sx={{
                                    display: 'grid',
                                ...
                                >
                                  ...
                                  <Box sx={{ minWidth: 0 }}>
                                    <Typography
                                      variant='body2'
                                      sx={{ fontWeight: 600, color: 'text.primary', lineHeight: 1.4, mb: 0.4 }}
                                    >
                                      {item.name}
                                    </Typography>
                                    <Box sx={{ display: 'inline-flex', alignItems: 'center', px: 0.75, py: 0.15, borderRadius: 0.5 }}>
                                      <Typography variant='caption' sx={{ fontFamily: 'monospace', fontSize: '0.63rem', color: '#64748b', letterSpacing: '0.02em' }}>
                                        SKU: {item.sku}
                                      </Typography>
                                    </Box>
                                  </Box>
                                  ...
                                  <Box sx={{ textAlign: 'center' }}>
                                    <Typography variant='caption' sx={{ display: 'block', color: 'text.disabled', fontSize: '0.62rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em', mb: 0.3 }}>
                                      Qty
                                    </Typography>
