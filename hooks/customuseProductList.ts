...
import { ProductFiltersDocument } from '@graphcommerce/magento-product/components'
import type {
  ProductListQuery,
  ProductListQueryVariables,
} from '@graphcommerce/magento-product/components/ProductList/ProductList.gql'
import { ProductListDocument } from '@graphcommerce/magento-product/components/ProductList/ProductList.gql'
import type { CategoryDefaultFragment } from '@graphcommerce/magento-product/components/ProductListItems/CategoryDefault.gql'
import type { ProductListParams } from '@graphcommerce/magento-product/components/ProductListItems/filterTypes'
import { toProductListParams } from '@graphcommerce/magento-product/components/ProductListItems/filterTypes'
//import { useRouterFilterParams } from '@graphcommerce/magento-product//components/ProductListItems/filteredProductList'

import { customuseRouterFilterParams } from '../components/ProductListItems/customfilteredProductList'
import {
  categoryDefaultsToProductListFilters,
  productListApplyCategoryDefaults,
  useProductListApplyCategoryDefaults,
} from '@graphcommerce/magento-product/components/ProductListItems/productListApplyCategoryDefaults'
 ...
 */
export function customuseProductList<
...
>(props: T) {
  ...
  const { params, shallow } = customuseRouterFilterParams(props)
